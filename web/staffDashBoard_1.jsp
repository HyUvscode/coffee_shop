<%-- 
    Document   : staffDashBoard_1
    Created on : Oct 24, 2023, 9:59:10 PM
    Author     : khuy
--%>
        ...
        <%
              if (session.getAttribute("login") == null) {
                    ...
                    if (session.getAttribute("login").equals("staff")) {
                          String id_info = request.getParameter("staff");
                          AccountDAO aO = new AccountDAO();
                          accounts acc = aO.getAccount(id_info);
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    <a href="/role/St?staff=<%=staff_id%>" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">Recent Orders</a>
                    <a href="/logout" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold"><i
                    <a href="/Order?staff=<%=staff_id%>&Order_id?=" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">Order</a>
                    <a href="/logout" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold"><i
                ...
                <div class="row my-5">
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                <%
                                      ResultSet rs = aO.getAllOrdersByStaff(staff_id);
                                      int count = 0;
                                      if (rs != null) {
                                            while (rs.next()) {
                                                  count++;
