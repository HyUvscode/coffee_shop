        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-white" id="sidebar-wrapper">
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="/role/Ad?admin=<%=acc.getAccount_id()%>&q=2" class="list-group-item list-group-item-action bg-transparent second-text active"><i
            ...
            <div id="page-content-wrapper">
                ...
                <div class="col-xs-4 link" style="text-align: left; margin-left: 20px; margin-bottom: 20px">
                    <a class="btn btn-success v" href="#" class="disabled" data-toggle="modal"><i
                            class="material-icons">&#xE147;</i> <span>Insert Customer</span></a>
                </div>
                            ...
                            <table class="table table-striped bg-white rounded shadow-sm table-hover" id="example">
                                ...
                                <tbody>
                                    <%
                                          ...
                                          if (set != null) {
                                                while (set.next()) {
                                                      if (set.getString("role_id").equals("Cus")) {
                                                            count++;
                                    %>
                                    <tr>
                                        <th scope="row"><%= count%></th>
                                        <td>Cs_<%= set.getString("account_id")%></td>
